...
We build from the work of Flemming et al. \cite{fleming-opt} where the authors
address the case of ensembles of reversible reactions and propose to find
thermodynamically feasible mass-conserving fluxes via solving a linearly 
constrained convex optimization problem. In this work we generalize their 
work to weakly reversible networks, and propose an alternative version 
of the algorithm to tackle this case.
