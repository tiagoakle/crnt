...
assumptions.  First we will assume that each row of $Y$ is non-negative and has
at least one nonzero entry. This implies that the stoichiometric coefficients
...
\begin{proof} 
    ...
    The set $\Omega$ is bounded since all elements have non-negative entries and
